...
class MainActivity : AppCompatActivity() {
    ...
    companion object PermissionsCode{
        private val PERMISSION_CODE_IMAGE_PICK = 1
        private val IMAGE_PICK_CODE = 2
        private val PERMISSION_CODE_OPEN_CAMERA = 3
        private val OPEN_CAMERA_CODE = 4
    }
        ...
        open_camera_button.setOnClickListener {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                ...
                if(checkSelfPermission(Manifest.permission.CAMERA) ==
                    ...
                    requestPermissions(permissions, PERMISSION_CODE_OPEN_CAMERA)
